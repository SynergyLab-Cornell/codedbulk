...
// suppose the matrix is at most 10 x 10
...
public:
  ...
  public:
    ...
    VirtualLinkInputPaths() : _path_ids(nullptr), _size(0) {}
    ~VirtualLinkInputPaths() {
      if(_path_ids != nullptr) {
        delete [] _path_ids;
      }
    }
  ...
  public:
    ...
    VirtualLinkOutputPaths() : _path_ids(nullptr), _size(0) {}
