...
#ifndef CodedBulk_OPTIMAL_STEINER_ROUTING_H
#define CodedBulk_OPTIMAL_STEINER_ROUTING_H
 ...
 */
class CodedBulkOptimalSteinerRouting : public CodedBulkRoutingAlgorithm {
public:
  virtual void GetPaths (Ptr<CodedBulkTraffic> traffic);
};

#endif /* CodedBulk_OPTIMAL_STEINER_ROUTING_H */
