...
public:
  ...
  /* MPLS support */
  //bool PushMPLSTag(uint32_t packet_uid, MPLSHeader &mpls);
  //bool PopMPLSTag(uint32_t packet_uid);
...
protected:
   ...
   */
  virtual ofpbuf * BufferFromPacket (Ptr<const Packet> packet, Address src, Address dst, int mtu, uint16_t protocol);
