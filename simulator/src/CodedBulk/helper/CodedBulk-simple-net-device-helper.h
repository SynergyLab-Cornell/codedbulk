 ...
 */
#ifndef CodedBulk_SIMPLE_NETDEVICE_HELPER_H
#define CodedBulk_SIMPLE_NETDEVICE_HELPER_H
 ...
 */
class CodedBulkSimpleNetDeviceHelper
{
public:
  /**
   * Construct a CodedBulkSimpleNetDeviceHelper.
   */
  CodedBulkSimpleNetDeviceHelper ();
  virtual ~CodedBulkSimpleNetDeviceHelper () {}
   ...
   * SimpleNetDevice created through CodedBulkSimpleNetDeviceHelper::Install.
   */
   ...
   * by CodedBulkSimpleNetDeviceHelper::Install
   */
   ...
   * CodedBulkSimpleNetDeviceHelper::SetChannelAttribute, an ns3::SimpleNetDevice with the attributes
   * configured by CodedBulkSimpleNetDeviceHelper::SetDeviceAttribute and then adds the device
   ...
   * CodedBulkSimpleNetDeviceHelper::SetDeviceAttribute and then adds the device to the node and
  ...
  /**
   * This method creates an ns3::SimpleChannel with the attributes configured by
   * CodedBulkSimpleNetDeviceHelper::SetChannelAttribute.  For each Ptr<node> in the provided
   * container: it creates an ns3::SimpleNetDevice (with the attributes
   * configured by CodedBulkSimpleNetDeviceHelper::SetDeviceAttribute); adds the device to the
   ...
   * CodedBulkSimpleNetDeviceHelper::SetDeviceAttribute); adds the device to the node; and attaches
...
#endif /* CodedBulk_SIMPLE_NETDEVICE_HELPER_H */
